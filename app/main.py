...
from app.routes import rutas, inventario_rutas, productos_rutas, camara_rutas, antenas_rutas, mantenimientos_rutas, proceso_rutas, utiliza_rutas, password_rutas
